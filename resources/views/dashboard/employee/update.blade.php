@foreach ($data as $item)
    <div class="modal fade" id="updateEmployee{{ $item->id }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Masukan nama karyawan" id="name" value="{{ $item->name }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" inputmode="numeric" pattern="[0-9]*"
                                        ...
                                        placeholder="Masukan NIK Karyawan" id="nik" name="nik"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('position') is-invalid @enderror"
                                        placeholder="Masukan posisi/ jabatan" id="position"
                                        value="{{ $item->position }}" name="position" required />
                                </div>
                                @error('position')
                                    <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="join_date" value="{{ $item->join_date }}" required />
                                </div>
                                @error('join_date')
                                    <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
                                @enderror
