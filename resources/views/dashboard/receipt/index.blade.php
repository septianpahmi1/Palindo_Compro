                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">DataTable Receipt</h3>
                        ...
                        @include('dashboard.receipt.create')
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ Carbon\Carbon::parse($item->fate)->format('d/m/Y') }}</td>
                                            <td>Rp {{ number_format($item->total, 0, ',', '.') }}</td>
                                            <td>{{ Str::limit($item->description, 25) }}</td>
                                            <td>
                                                <div class="btn-group btn-flat btn-block">
                                                    <button url="{{ route('receipt.delete', $item->id) }}"
