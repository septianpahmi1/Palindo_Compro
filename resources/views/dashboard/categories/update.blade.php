<div class="modal fade" id="updateCat{{ $item->id }}">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Masukan nama category" value="{{ $item->name }}" id="name"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rupiah @error('cost') is-invalid @enderror"
                                    placeholder="Masukan jumlah biaya" value="{{ $item->cost }}" id="cost"
                                    name="cost" required />
                            </div>
                            @error('cost')
                                <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rupiah @error('benefit') is-invalid @enderror"
                                    placeholder="Masukan jumlah keuntungan" value="{{ $item->benefit }}" id="benefit"
                                    name="benefit" />
                            </div>
                            @error('benefit')
                                <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
